...
//   megaMenu.classList.remove("fade")
//   megaMenu.classList.add("show")
// };
// function closeMega() {
//   let megaMenu = document.querySelector(".mega-menu");
//   megaMenu.classList.remove("show")
//   megaMenu.classList.add("fade")
// };
// let close = document.querySelector('.close');

// close.onclick = function () {
//   let megaMenu = document.querySelector(".mega-menu");
//   megaMenu.style.cssText = "z-index: -1; opacity: 0;"
// }; 
...
// ScrollReveal().reveal('i,.imagge, li ,.info a , .main-heading p, .shuffle ,.copyright , .subscribe p , .foot' , { origin: 'top'});
